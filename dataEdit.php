            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Ma'lumot tahrirlash<a href="index.php" class="btn btn-danger float-end">Chiqish</a></h5>
                    </div>
                    <div class="card-body">
                        <?php
                            $sum = "anodra";    
                        ...
                        <form action="create.php" method="post">
                            <div class="row px-sm-5">
                                ...
                                <button type="submit" class="btn btn-primary float-end" name="update-data">
                                    Tahrirlash
                                </button>
                                </div>
                            </div>
